...
class Movements {
  ...
  /** @type {boolean} */ canOpenDoors
  
  /** @type {boolean} */ sneak

  /** @readonly @type {boolean} */ dontCreateFlow
  
  /** @readonly @type {boolean} */ dontMineUnderFallingBlock
  
  /** @type {boolean} */ allow1by1towers
  
  /** @readonly @type {boolean} */ allowFreeMotion
  ...
  constructor (bot) {
    ...
    registry.blocksArray.forEach((/** @type {any} */ block) => {
    ...
    registry.blocksArray.map((/** @type {any} */ x) => Block.fromStateId(x.minStateId, 0)).forEach((/** @type {any} */ block) => {
  ...
  /**
   * @param {Vec3 & { remainingBlocks: number; }} node
